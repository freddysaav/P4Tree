...
control MyIngress(inout headers hdr,
   ...
   action set_egress_port(bit<9> egress_port){
	...
	meta.class5 = CLASS_NOT_SET;
 	meta.class6 = CLASS_NOT_SET;
	meta.class7 = CLASS_NOT_SET;	
    }
    ...
    apply {
		...
		if (meta.class6 == CLASS_NOT_SET) meta.class6 = 0;
		if (meta.class7 == CLASS_NOT_SET) meta.class7 = 0;		


		meta.class = meta.class1 + meta.class2 + meta.class3 + meta.class4 + meta.class5 + meta.class6 + meta.class7;

		if (meta.class < 4) meta.class = 0;
		else meta.class = 1;
